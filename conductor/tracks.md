...
- [x] **Track: I'd like to change the heading slightly. The current "Connected to Comfyui" badge is large and takes up too much space on mobile. Can you make it just a red/green indicator with a hover that shows the details**
