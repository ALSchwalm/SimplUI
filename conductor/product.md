...
- **Batch Results (Gallery):** For batch generations, the application displays results in a gallery, allowing users to view all generated images in real-time as they are completed.
