...
def test_extract_workflow_inputs():
    workflow = {
        ...
        "3": {
            "_meta": {"title": "Prompt"},
            "inputs": {"text": "This should be filtered", "other_param": 123},
        },
    }
...
def test_extract_workflow_inputs_seed_randomization():
    ...
    workflow = {
        "1": {
            "_meta": {"title": "KSampler"},
            "inputs": {"seed": 0, "steps": 20},  # Should default to random
        },
        "2": {
...
def test_extract_workflow_inputs_with_metadata():
    ...
    # Mock Object Info
    object_info = {
        "KSampler": {"input": {"required": {"sampler_name": [["euler", "ddim", "heun"]]}}}
    }
...
def test_get_prompt_default_value():
    ...
    workflow_case = {"1": {"_meta": {"title": "PROMPT"}, "inputs": {"string": "A photo of a dog"}}}
    assert get_prompt_default_value(workflow_case) == "A photo of a dog"

    # Workflow without Prompt node
    workflow_no_prompt = {"1": {"_meta": {"title": "KSampler"}, "inputs": {}}}
...
def test_extract_workflow_inputs_sliders():
    ...
    workflow = {
        "1": {
            "_meta": {"title": "KSampler"},
            "class_type": "KSampler",
            "inputs": {"steps": 20, "cfg": 8.0, "other": 50},
        }
    }
